...
Production build with AdSense-readiness and homepage media polish. See `docs/RELEASE-NOTES-V1.2.8.md`.
...
- Public pages display only `VentTools V1.2.5`.
...
- Public pages show only VentTools V1.2.5.
