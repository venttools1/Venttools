...
Production build with the simplified, fitter-first Duct Size Converter. See `docs/RELEASE-NOTES-V1.2.4.md`.
...
- Public pages display only `VentTools V1.2.4`.
...
- Public pages show only VentTools V1.2.4.
...
- Public UI shows only VentTools V1.2.4.
