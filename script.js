...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="color-scheme" content="light"><title>${esc(ref)} — VentTools Site Instruction Sheet</title>
<style>
...
<footer><span>Source: ${esc(p.guide)} — ${esc(p.revision)}</span><span>Generated by VentTools V6.5 RC9</span></footer>
  ...
  try{
    ...
    try{const blob=new Blob([html],{type:"text/html"});w.location.href=URL.createObjectURL(blob)}catch(err){try{w.close()}catch(closeErr){}fdMsg("warn","The site sheet could not be opened on this device.")}
  }
}
